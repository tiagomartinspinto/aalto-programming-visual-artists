...
Year landing pages use the same section order: current session, web sketches, Lab, sessions, slides, projects, and Processing/p5.js comparison. Keep that structure stable so each academic year feels like the same archive with different course content.
