...
[Sketch Lab](web/lab.html) is an in-browser editor for the p5.js companion sketches. Students can choose a sketch, edit the JavaScript, and run it immediately without installing anything. Changes stay local in the browser and are not uploaded or saved automatically.
