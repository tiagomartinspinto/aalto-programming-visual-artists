...
function draw() {
  if (isFleeing) {
    ...
    let d = sqrt(dx * dx + dy * dy); // Calculates the straight-line distance between the shape and the mouse. Used Claude as help for this.
    let fleeRadius = 150; // How close you have to be for it to flee

    // Tells which direction to flee in and how urgently. Used Claude as help for this.
    if (d < fleeRadius) {
