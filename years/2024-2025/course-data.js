// Source of truth for the 2024-2025 year page.
...
window.COURSE_DATA = {
  ...
  currentSession: {
    ...
    links: [
      ...
      { label: "Open Session 08 deck", href: "#slides", pdf: "slides/session-08.pdf", title: "Session 08 - Sound and camera" },
    ],
  },
  sessions: [
    { id: "session-01", kicker: "Session 01", title: "Drawing basics", description: "Coordinates, shapes, color, and first reusable drawing functions.", duration: "2h 45m", tags: ["drawing", "coordinates", "functions"], href: "sessions/session-01/", links: [{ label: "Open session page", href: "sessions/session-01/", primary: true }, { label: "Open slide deck", href: "#slides", pdf: "slides/session-01.pdf", title: "Session 01 - Drawing basics" }] },
    { id: "session-02", kicker: "Session 02", title: "Mouse and variables", description: "Mouse input, values, operators, and color changes.", duration: "2h 45m", tags: ["mouse", "variables", "interaction"], href: "sessions/session-02/", links: [{ label: "Open session page", href: "sessions/session-02/", primary: true }, { label: "Open slide deck", href: "#slides", pdf: "slides/session-02.pdf", title: "Session 02 - Mouse and variables" }] },
    { id: "session-03", kicker: "Session 03", title: "Conditionals and movement", description: "Hover states, collisions, changing color, and motion over time.", duration: "2h 45m", tags: ["conditionals", "motion", "state"], href: "sessions/session-03/", links: [{ label: "Open session page", href: "sessions/session-03/", primary: true }, { label: "Open slide deck", href: "#slides", pdf: "slides/session-03.pdf", title: "Session 03 - Conditionals and movement" }] },
    { id: "session-04", kicker: "Session 04", title: "Loops, grids, and waves", description: "Nested loops, repeated structures, waves, and generative grids.", duration: "2h 45m", tags: ["loops", "grids", "waves"], href: "sessions/session-04/", links: [{ label: "Open session page", href: "sessions/session-04/", primary: true }, { label: "Open slide deck", href: "#slides", pdf: "slides/session-04.pdf", title: "Session 04 - Loops, grids, and waves" }] },
    { id: "session-05", kicker: "Session 05", title: "Functions and recursion", description: "Reusable code, recursive drawing, spiral systems, and noise.", duration: "2h 45m", tags: ["functions", "recursion", "noise"], href: "sessions/session-05/", links: [{ label: "Open session page", href: "sessions/session-05/", primary: true }, { label: "Open slide deck", href: "#slides", pdf: "slides/session-05.pdf", title: "Session 05 - Functions and recursion" }] },
    { id: "session-06", kicker: "Session 06", title: "Objects and particles", description: "Object-oriented thinking, arrays, particle systems, and repeated motion.", duration: "2h 45m", tags: ["objects", "arrays", "particles"], href: "sessions/session-06/", links: [{ label: "Open session page", href: "sessions/session-06/", primary: true }, { label: "Open slide deck", href: "#slides", pdf: "slides/session-06.pdf", title: "Session 06 - Objects and particles" }] },
    { id: "session-07", kicker: "Session 07", title: "Image and video", description: "Image filters, video filters, glitch effects, and zoom interactions.", duration: "2h 45m", tags: ["image", "video", "pixels"], href: "sessions/session-07/", links: [{ label: "Open session page", href: "sessions/session-07/", primary: true }, { label: "Open slide deck", href: "#slides", pdf: "slides/session-07.pdf", title: "Session 07 - Image and video" }] },
    { id: "session-08", kicker: "Session 08", title: "Sound and camera", description: "Audio, webcam, image-to-sound, kaleidoscopes, and media experiments.", duration: "2h 45m", tags: ["sound", "camera", "media"], href: "sessions/session-08/", links: [{ label: "Open session page", href: "sessions/session-08/", primary: true }, { label: "Open slide deck", href: "#slides", pdf: "slides/session-08.pdf", title: "Session 08 - Sound and camera" }] },
  ],
  sketches: [
    ...
    { id: "mouse-shapes", title: "Mouse Shapes", session: "Session 02", page: "web/mouse-shapes/", source: "source/session-02/mouseshapes/mouseshapes.pde", description: "Use the pointer to control one shape while another moves in the opposite direction.", try: "change color mappings, shape size, or opposite movement.", tags: ["mouseX", "mapping"], difficulty: "intro", related: ["color-house", "bouncing-ball"] },
